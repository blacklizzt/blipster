...
function time2str(date) {
    ...
    if (time < 60) {
        return parseInt(time) === 1 ? '1 minute ago' : parseInt(time) + ' minutes ago';
    }

    time = time / 60;

    if (time < 24) {
        return parseInt(time) === 1 ? '1 hour ago' : parseInt(time) + ' hours ago';
    }

    time = time / 24;
    if (time < 7) {
        return parseInt(time) === 1 ? '1 day ago' : parseInt(time) + ' days ago';
    }
                                 ...
                                 <nav class="level is-mobile">
                                     <div class="level-left">
                                         ...
                                         <a class="level-item is-sparta" aria-label="star" onclick="toggle_star('${post["_id"]}', 'star')">
                                            <span class="icon is-small">
                                                <i class="fa ${class_star}" aria-hidden="true">
                                                </i>
                                         ...
                                         <a class="level-item is-sparta" aria-label="thumbsup" onclick="toggle_thumbsup('${post["_id"]}', 'thumbsup')">
                                            <span class="icon is-small">
                                                <i class="fa ${class_thumbsup}" aria-hidden="true">
                                                </i>
